...
description: Extract design system from code, generate reference package,
  persist as knowledge assets
...
1. Before domain work, call `maestro run create maestro-ui-codify -- $ARGUMENTS` and retain the returned `run_id`, `run_dir`, and `upstream`.
