...
send_message(participant="coordinator", message="[verifier] VERIFY-001 passed. Score: X/32 -> Y/32 (+N). No regressions. Report: {run_dir}/outputs/verification/verify-report.md")
```
...
send_message(participant="coordinator", message="[verifier] VERIFY-001 failed. N regressions (non-critical). Score: X/32 -> Y/32. Report: {run_dir}/outputs/verification/verify-report.md")
```
...
send_message(participant="coordinator", message="[verifier] VERIFY-001 fix_required. N critical regressions. Score: X/32 -> Y/32 (DROPPED). Report: {run_dir}/outputs/verification/verify-report.md")
```
