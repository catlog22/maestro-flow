...
send_message(participant="coordinator", message="[scanner] SCAN-001 complete. Score: X/36 (<rating-band>). Issues: P0=N P1=N P2=N P3=N. Report: {run_dir}/outputs/scan/scan-report.md")
```
