...
description: Systematic experimental results analysis workflow for ML/AI
  ...
  Triggers on "analyze experimental results", "generate results section",
  "statistical analysis of experiments", "compare model performance", "create
...
|-------|----------|---------|---------|
| 1 | [phases/01-data-loading.md](phases/01-data-loading.md) | Load and validate data | update_plan driven |
| 2 | [phases/02-statistical-analysis.md](phases/02-statistical-analysis.md) | Statistical testing | update_plan driven + sentinel |
| 3 | [phases/03-visualization.md](phases/03-visualization.md) | Figure/table specs | update_plan driven |
| 4 | [phases/04-results-writing.md](phases/04-results-writing.md) | Draft Results section | update_plan driven + sentinel |
| 5 | [phases/05-quality-check.md](phases/05-quality-check.md) | Validate and verify | update_plan driven |
...
- [ ] update_plan updated (current phase completed, next phase in_progress)
