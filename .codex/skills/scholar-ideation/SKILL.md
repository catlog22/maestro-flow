...
Phase 1: Literature Search
   Mark update_plan Phase 1 → in_progress
...
Phase 2: Gap Analysis
   Mark update_plan Phase 1 → completed, Phase 2 → in_progress
...
Phase 3: Research Question Formulation
   Mark update_plan Phase 2 → completed, Phase 3 → in_progress
...
Phase 4: Method Selection
   Mark update_plan Phase 3 → completed, Phase 4 → in_progress
...
Phase 5: Research Planning
   Mark update_plan Phase 4 → completed, Phase 5 → in_progress
   └─ Ref: phases/05-research-planning.md
      ├─ Input: ALL previous outputs
      └─ Output: research-plan.md (final deliverable)

Mark update_plan Phase 5 → completed
```
...
|-------|----------|---------|---------|
| 1 | [phases/01-literature-search.md](phases/01-literature-search.md) | Search, discover, and organize literature | update_plan driven |
| 2 | [phases/02-gap-analysis.md](phases/02-gap-analysis.md) | Identify research gaps and opportunities | update_plan driven |
| 3 | [phases/03-research-question.md](phases/03-research-question.md) | Formulate research questions and hypotheses | update_plan driven |
| 4 | [phases/04-method-selection.md](phases/04-method-selection.md) | Select and justify research methods | update_plan driven + sentinel |
| 5 | [phases/05-research-planning.md](phases/05-research-planning.md) | Create timeline, milestones, and final plan | update_plan driven + sentinel |
...
- [ ] Collapse update_plan sub-tasks
