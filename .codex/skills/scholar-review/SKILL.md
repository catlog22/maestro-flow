...
description: Systematic academic paper review workflow covering self-review
  before submission and rebuttal writing after receiving reviewer feedback.
  Triggers on "review paper", "self-review", "write rebuttal", "respond to
  reviewers", "analyze review comments", "paper review".
allowed-tools:
  - Bash
  - Edit
  - Glob
...
Phase 1: Self-Review
  ...
  update_plan: Mark Phase 1 in_progress → completed
```
...
Phase 2: Review Analysis
  ...
  update_plan: Mark Phase 2 in_progress → completed
...
Phase 3: Response Strategy
  ...
  update_plan: Mark Phase 3 in_progress → completed
...
|-------|----------|---------|---------|
| 1 | [phases/01-self-review.md](phases/01-self-review.md) | Pre-submission quality check | update_plan driven |
| 2 | [phases/02-review-analysis.md](phases/02-review-analysis.md) | Parse and classify reviewer comments | update_plan driven |
| 3 | [phases/03-response-strategy.md](phases/03-response-strategy.md) | Plan rebuttal strategy per comment | update_plan driven + sentinel |
| 4 | [phases/04-rebuttal-writing.md](phases/04-rebuttal-writing.md) | Write structured rebuttal document | update_plan driven + sentinel |
| 5 | [phases/05-revision.md](phases/05-revision.md) | Plan and track paper revisions | update_plan driven |

**Compact Rules**:
1. **update_plan `in_progress`** -> Preserve full content, do not compress
2. **update_plan `completed`** -> May compress to summary
...
- [ ] update_plan updated: current phase `in_progress`
- [ ] Read phase document via `Ref:` marker

### After Each Phase
- [ ] Output file generated and saved
- [ ] update_plan updated: current phase `completed`
