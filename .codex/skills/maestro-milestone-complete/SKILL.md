...
**Dedup**: Run `maestro load --type spec --category learning` to load existing entries. Skip any extracted learning whose keywords fully overlap with an existing entry.
