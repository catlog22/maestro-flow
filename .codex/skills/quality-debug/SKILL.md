---
name: quality-debug
description: Use when bugs, test failures, or unexpected behavior need
  systematic root cause investigation
argument-hint: '[-y|--yes] [-c|--concurrency N] [--continue] "[bug description]
  [--from-uat <phase>] [--parallel]"'
