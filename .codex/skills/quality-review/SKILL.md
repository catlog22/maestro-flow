---
name: quality-review
description: Use after execution to evaluate code quality across correctness,
  security, performance, and architecture
argument-hint: '[-y|--yes] [-c|--concurrency N] [--continue] "<phase> [--level
  quick|standard|deep] [--dimensions list]"'
