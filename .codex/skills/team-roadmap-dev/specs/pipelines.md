...
|--------|------|-----------|------------|
| PLAN | planner | `~  or <project>/.codex/skills/team-roadmap-dev/roles/planner/role.md` | true |
| EXEC | executor | `~  or <project>/.codex/skills/team-roadmap-dev/roles/executor/role.md` | true |
