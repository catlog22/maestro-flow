...
|-------|----------|---------|---------|
| 1 | [phases/01-presentation.md](phases/01-presentation.md) | Slide outline creation | update_plan driven |
| 2 | [phases/02-poster.md](phases/02-poster.md) | Poster layout design | update_plan driven |
| 3 | [phases/03-promotion.md](phases/03-promotion.md) | Multi-platform promotion | update_plan driven |

**Compact Rules**:
1. **update_plan `in_progress`** -> preserve full content, do not compress
2. **update_plan `completed`** -> can compress to summary
...
- [ ] update_plan updated (phase marked completed)
