...
|-------|----------|---------|---------|
| 1 | [phases/01-setup.md](phases/01-setup.md) | Initialize workspace and state | update_plan 驱动 |
| 2 | [phases/02-execute.md](phases/02-execute.md) | Execute skill via maestro delegate Claude | update_plan 驱动 + 🔄 sentinel |
| 3 | [phases/03-evaluate.md](phases/03-evaluate.md) | Evaluate via maestro delegate Agy | update_plan 驱动 + 🔄 sentinel |
| 4 | [phases/04-improve.md](phases/04-improve.md) | Apply improvements via Agent | update_plan 驱动 + 🔄 sentinel |
| 5 | [phases/05-report.md](phases/05-report.md) | Generate final report | update_plan 驱动 |
...
- [ ] Update update_plan with iteration status
...
- [ ] Update all update_plan tasks to completed
