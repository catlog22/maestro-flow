...
description: Four-layer citation verification for academic papers. Scans
  LaTeX/BibTeX files, verifies every citation via WebSearch and Google Scholar,
  generates verification report with fix suggestions. Triggers on "verify
  citations", "check references", "citation verification", "prevent fake
  citations", "引用验证".
allowed-tools:
  - Bash
  - Edit
...
|-------|----------|---------|---------|
| 1 | [phases/01-scan-extract.md](phases/01-scan-extract.md) | Scan files, extract citations | update_plan driven |
| 2 | [phases/02-verify.md](phases/02-verify.md) | 4-layer verification | update_plan driven + sentinel |
| 3 | [phases/03-report-fix.md](phases/03-report-fix.md) | Generate report, apply fixes | update_plan driven |
