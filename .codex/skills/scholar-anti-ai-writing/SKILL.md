...
description: Remove AI writing patterns from academic prose. Detects and fixes
  ...
  Chinese. Triggers on "remove AI patterns", "humanize text", "anti-AI polish",
  "去除AI写作痕迹", "人性化处理".
allowed-tools:
  - Bash
  - Edit
...
|-------|----------|---------|---------|
| 1 | [phases/01-detect-score.md](phases/01-detect-score.md) | Scan patterns, score text | update_plan driven |
| 2 | [phases/02-rewrite-polish.md](phases/02-rewrite-polish.md) | Rewrite and humanize | update_plan driven + sentinel |
| 3 | [phases/03-validate-score.md](phases/03-validate-score.md) | Re-score, generate report | update_plan driven |
