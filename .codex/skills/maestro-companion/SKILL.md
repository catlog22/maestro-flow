...
description: Knowledge companion — load context, record companion doc, capture
  insights, route to skills
argument-hint: "[before|note|after|route] [--task <description>] [--type
  <task_type>] [--category <cat>] [-y]"
