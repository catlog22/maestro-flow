...
const HOOK_SCRIPT_MARKERS = [
  ...
  'workflows/impeccable/scripts/hook.mjs',
  'workflows/impeccable/scripts/hook-before-edit.mjs',
];
...
const HOOK_MARKER = /(?:skills\/impeccable|workflows\/impeccable)\/scripts\/hook(?:-before-edit)?\.mjs/;
...
function hookScriptTokenFrom(command) {
  ...
  const quoted = str.match(/"([^"]*(?:skills\/impeccable|workflows\/impeccable)\/scripts\/hook(?:-before-edit)?\.mjs)"/);
  ...
  const singleQuoted = str.match(/'([^']*(?:skills\/impeccable|workflows\/impeccable)\/scripts\/hook(?:-before-edit)?\.mjs)'/);
  if (singleQuoted) return singleQuoted[1];
  const bare = str.match(/([^\s"'|&;()]*(?:skills\/impeccable|workflows\/impeccable)\/scripts\/hook(?:-before-edit)?\.mjs)/);
