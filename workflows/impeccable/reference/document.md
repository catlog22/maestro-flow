...
```markdown
<!-- SEED: established with the user before implementation; re-run /maestro-impeccable document once there's code to capture the actual tokens and components. -->
```
