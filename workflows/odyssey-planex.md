---
name: odyssey-planex
prepare: odyssey-planex
session-mode: inherited
---

# Workflow: Odyssey Planex
...
|---------------|--------|------|
| S_INTAKE criteria | [@ask] AskUserQuestion | auto-derive `deferred` |
| S_EXECUTE options | [@ask] AskUserQuestion | defaults (auto/Skip/Auto) `confirmed:true` |
| S_EXECUTE task blocked | [@ask] AskUserQuestion | auto continue, log blocked |
| S_VERIFY manual criterion | [@ask] AskUserQuestion | `deferred` |
| S_VERIFY max iteration | [@ask] AskUserQuestion | auto accept `deferred` |
| A_DISCOVER routing | [@ask] AskUserQuestion | auto-route to execute, issue for rest |
