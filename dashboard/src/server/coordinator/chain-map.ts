...
export const INTENT_PATTERNS: Array<[string, RegExp]> = [
  ...
  ['execute',           /execute|implement|build|develop|code|实现|开发|verif[iy]|validate.*result|验证|校验/i],
...
export const CHAIN_MAP: Record<string, ChainStepDef[]> = {
  ...
  'ui-craft-build':       [{ cmd: 'maestro-impeccable', args: '"{phase}" --chain build' }, { cmd: 'maestro-plan', args: '{phase}' }, { cmd: 'maestro-execute', args: '{phase}' }],
  'full-lifecycle':       [{ cmd: 'maestro-plan', args: '{phase}' }, { cmd: 'maestro-execute', args: '{phase}' }, { cmd: 'quality-review', args: '{phase}' }, { cmd: 'quality-test', args: '{phase}' }, { cmd: 'maestro-milestone-audit' }, { cmd: 'maestro-milestone-complete' }],
  'quality-loop':         [{ cmd: 'quality-review', args: '{phase}' }, { cmd: 'quality-test', args: '{phase}' }, { cmd: 'quality-debug', args: '--from-uat {phase}' }, { cmd: 'maestro-plan', args: '{phase} --gaps' }, { cmd: 'maestro-execute', args: '{phase}' }],
