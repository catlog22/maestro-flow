...
const automatic = new Set(['maestro-next', 'maestro', 'maestro-ralph', 'maestro-companion', 'maestro-knowledge']);
...
if (errors.length) {
  ...
  process.exitCode = 1;
} else console.log('invocation policy lint passed: maestro-next, maestro, maestro-ralph, maestro-companion, maestro-knowledge are the only automatic entrypoints');
