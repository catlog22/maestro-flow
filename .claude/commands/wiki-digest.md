...
| W002 | warning | LRN-insights.md not found — skipping cross-reference | Proceed without knowhow context |
...
- [ ] Meta-insights appended to `LRN-insights.md` as `<knowhow-entry>` blocks
