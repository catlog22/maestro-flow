---
name: maestro-grill
description: Socratic pressure-test a plan/idea/requirement against codebase reality — adversarial questioning, terminology collision checks, branch-by-branch evidence gathering
