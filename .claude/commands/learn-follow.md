...
2. Append each new pattern/technique as a `<spec-entry>` block to `specs/learnings.md` via `maestro spec add learning --category <cat> --body "<content>" --keywords "follow,{target-slug}"`:
