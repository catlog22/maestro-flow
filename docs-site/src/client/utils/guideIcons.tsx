// ---------------------------------------------------------------------------
// guideIcons — line-style SVG icons for guide navigation
// Matches the feather/lucide style used elsewhere in the sidebar
// ---------------------------------------------------------------------------
...
const iconMap: Record<string, React.FC<IconProps>> = {
  ...
  'hook': ({ className }: IconProps) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M18 5v6a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4V5" />
  ...
  'handshake': ({ className }: IconProps) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M20 17l-2-2" />
      <path d="M4 17l2-2" />
      <path d="M12 19l-2-2 4-4 2 2" />
      <path d="M8 13l-4-4 8-4 4 4" />
      <path d="M16 9l4-4-8-4-4 4" />
    </svg>
  ),
  ...
  'graduation-cap': ({ className }: IconProps) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  'palette': ({ className }: IconProps) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.93 0 1.5-.67 1.5-1.5 0-.39-.15-.74-.39-1.04-.24-.3-.39-.65-.39-1.04 0-.84.67-1.5 1.5-1.5H16c3.31 0 6-2.69 6-6 0-5.5-4.5-9.92-10-9.92z" />
    </svg>
  ),
  'refresh-cw': ({ className }: IconProps) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  'shield-check': ({ className }: IconProps) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
