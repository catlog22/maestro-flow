...
- Are changes out of bounds? Write only source-code changes and this run's domain artifacts; protocol state (seal, artifact registration) is handled by the CLI — do not manually edit state.
